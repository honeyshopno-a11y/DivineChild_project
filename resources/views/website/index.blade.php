    ...
    <div class="main-wrapper">
                ...
                <div class="container">
                    <div class="header-top-wrap">
                        <div class="header-top-info">
                            <ul>
                                <li><i class="flaticon-phone-call"></i> Call {{ $contact->number ?? '-' }} </li>
        ...
        <div class="offcanvas offcanvas-start" id="offcanvasMenu">
            <div class="offcanvas-header">
                <div class="offcanvas-logo"><a href="#"><img src="{{ asset('website/assets/images/logo/dchs-logo.png')}}"
                            alt=""></a></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="category-item color-4">
                                    <div class="category-icon">
                                        <img src="{{ asset('website/assets/images/icons/fire-safety.png')}}"
                                            alt="Fire Safety">
                                    </div>
                                    <div class="category-content">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6">
                                <div class="features-item text-center">
                                    <div class="features-img"><img
                                            src="{{ asset('website/assets/images/icons/icon-01.png')}}" alt=""></div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="features-item text-center">
                                    <div class="features-img"><img
                                            src="{{ asset('website/assets/images/icons/icon-02.png')}}" alt=""></div>
                                    <div class="features-content">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="features-item text-center">
                                    <div class="features-img"><img
                                            src="{{ asset('website/assets/images/icons/icon-03.png')}}" alt=""></div>
                                    <div class="features-content">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="features-item text-center">
                                    <div class="features-img"><img
                                            src="{{ asset('website/assets/images/icons/icon-04.png')}}" alt=""></div>
                                    <div class="features-content">
