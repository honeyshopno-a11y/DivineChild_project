...
@section('content')
    ...
    <title>Public Disclosure List</title>
    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        ...
        <div
            ...
            <div class="d-flex align-content-center flex-wrap gap-4 mt-2 mt-md-0">
                ...
                <a href="{{ route('public-disclosure-add-edit', 'add') }}" role="button" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="datatables-products table dataTable dtr-column collapsed mt-3" id="myTable"
                            ...
                            <tbody>
                                ...
                                @if(!empty($disclosure_data) && count($disclosure_data) != 0)

                                    @foreach ($disclosure_data as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if($item->pdf)
                                                    ...
                                                    <a href="{{ asset($item->pdf) }}" target="_blank" class="btn btn-sm btn-primary">
                                            ...
                                            <td class="text-center">
                                                ...
                                                {{-- Edit --}}
                                                <a href="{{ route('public-disclosure-add-edit', $item->id) }}" role="button"
                                                ...
                                                {{-- Delete --}}
                                                <a href="{{ route('public-disclosure-delete', $item->id) }}"
                                                    class="btn btn-danger p-0"
                                                    onclick="confirmDelete(event, '{{ route('public-disclosure-delete', $item->id) }}')">
