    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        ...
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 ps-1">Transfer Certificate List</h4>
            </div>

            <div class="d-flex align-content-center flex-wrap gap-4 mt-2 mt-md-0">
                <a href="{{ route('transfer-certificate-add') }}" role="button" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <table class="datatables-products table dataTable dtr-column collapsed mt-3" id="myTable"
                            ...
                            <tbody>
                                ...
                                @if(count($transfer_certificate_data) != 0)

                                    @foreach ($transfer_certificate_data as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <!-- DELETE ONLY -->
                                                <a href="{{ route('transfer-certificate-delete', $item->id) }}"
                                                    class="btn btn-danger p-0"
                                                    onclick="confirmDelete(event, '{{ route('transfer-certificate-delete', $item->id) }}')">
