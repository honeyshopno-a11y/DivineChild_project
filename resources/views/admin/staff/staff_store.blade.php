    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card mb-6">
                    <div class="card-body">
                        <form class="form" action="{{ route('staff-store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id"
                                @if ($staff_data == '') value="add" @else
                            value="{{ $staff_data->id }}" @endif>
                            <div class="row">
                                <div class="col-12 col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Enter Name"
                                            value="{{ $staff_data->name ?? old('name') }}" required>
                                        @error('name')
                                ...
                                <div class="col-12 col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="role" class="form-control" placeholder="Enter Role"
                                            value="{{ $staff_data->role ?? old('role') }}" required>
                                        @error('role')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12 col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-0 pt-0">
                                            @if ($staff_data != '' && $staff_data->image != '')
                                                <img src="{{ asset($staff_data->image) }}" id="image_select"
