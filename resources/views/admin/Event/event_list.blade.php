    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        ...
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 ps-1">Event List</h4>
            </div>

            <div class="d-flex align-content-center flex-wrap gap-4 mt-2 mt-md-0">
                <a href="{{ route('event-add-edit', 'add') }}" role="button" class="btn btn-primary">
                    Add Event
                </a>
            </div>
                                    ...
                                    @foreach ($event_data as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('event-add-edit', $item->id) }}" class="btn btn-primary p-0">
                                                    <i class='bxr bx-edit m-0 p-2' style="font-size:17px;"></i>
                                                </a>

                                                <a href="{{ route('event-delete', $item->id) }}" class="btn btn-danger p-0"
                                                    onclick="confirmDelete(event, '{{ route('event-delete', $item->id) }}')">
