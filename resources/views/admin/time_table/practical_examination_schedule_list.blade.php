...
@section('title', 'Practical Examination Schedule List')
@section('content')
    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 ps-1">Practical Examination Schedule List</h4>
            </div>
            <div class="d-flex align-content-center flex-wrap gap-4 mt-2 mt-md-0">
                <a href="{{ route('practical.examination.schedule.addedit', 'add') }}" role="button" class="btn btn-primary">Add Practical Examination Schedule</a>
            </div>
        </div>
                ...
                <div class="card mb-6">
                    <div class="card-body">
                        <table class="datatables-products table dataTable dtr-column collapsed mt-3 text-center"
                            ...
                            <tbody>
                                @if (isset($practicalExaminationScheduleList))
                                    @foreach ($practicalExaminationScheduleList as $key => $list)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('practical.examination.schedule.addedit', $list->id) }}"
                                                    role="button" class="btn btn-primary p-0">
                                                    <i class='bxr  bx-edit m-0 p-2' style="font-size: 17px;"></i>
                                                </a>
                                                <a href="{{ route('practical.examination.schedule.delete', $list->id) }}"
                                                    class="btn btn-danger p-0"
                                                    onclick="confirmDelete(event, '{{ route('practical.examination.schedule.delete', $list->id) }}')">
