    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        ...
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 ps-1">Management List</h4>
            </div>

            <div class="d-flex align-content-center flex-wrap gap-4 mt-2 mt-md-0">
                <a href="{{ route('management-add-edit', 'add') }}" role="button" class="btn btn-primary">
                    Add Management
                </a>
            </div>
                        ...
                        <table class="datatables-products table dataTable dtr-column collapsed mt-3" id="myTable"
                            ...
                            <tbody>
                                ...
                                @if(count($management_data) != 0)
                                    ...
                                    @foreach ($management_data as $key => $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if($item->image != '')
                                                    <img src="{{ asset($item->image) }}" alt="Management Image" width="80" height="80"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ route('management-add-edit', $item->id) }}" role="button"
                                                ...
                                                <a href="{{ route('management-delete', $item->id) }}" class="btn btn-danger p-0"
                                                    onclick="confirmDelete(event, '{{ route('management-delete', $item->id) }}')">
