    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        <div
            ...
            <div class="d-flex flex-column justify-c ontent-center">
                <h4 class="mb-1 ps-1">
                    @if ($syllabus_data == '') Add a New @else Edit @endif syllabus
                </h4>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="card mb-6">
                    <div class="card-body">
                        <form class="form" action="{{ route('syllabus-store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" @if ($syllabus_data == '') value="add" @else
                            value="{{ $syllabus_data->id }}" @endif>
                            <div class="row">
                            ...
                            <div class="col-12 col-lg-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        ...
                                        @if ($syllabus_data=='' ) value="{{ old('title') }}" @else value="{{ $syllabus_data->title }}" @endif>
                                    @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control @error('pdf') is-invalid @enderror"
                                            id="pdf" name="pdf" accept=".pdf">
                                                ...
                                                @if($syllabus_data != '' && $syllabus_data->pdf != '')
                                                    <div class="mt-3">
                                                        <a href="{{ asset($syllabus_data->pdf) }}"
                                                        target="_blank"
