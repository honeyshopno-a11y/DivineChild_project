    ...
    <div class="px-3 px-md-5 flex-grow-1 container-p-y">
        <div
            ...
            <div class="d-flex flex-column justify-c ontent-center">
                <h4 class="mb-1 ps-1">
                    @if ($gallery_data == '') Add a New @else Edit @endif Gallery
                </h4>
            </div>
        </div>
                ...
                <div class="card mb-6">
                    <div class="card-body">
                        <form class="form" action="{{ route('gallery-store') }}" method="POST"
                            ...
                            @csrf
                            <input type="hidden" name="id" @if ($gallery_data == '') value="add" @else
                            value="{{ $gallery_data->id }}" @endif>
                            <div class="row">
                                <div class="col-12 col-lg-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-0 pt-0">
                                            @if($gallery_data != '' && $gallery_data->image != '')
                                                <img src="{{ asset($gallery_data->image) }}" id="image_select"
